...
class _NomosFinanceState extends State<NomosFinance> {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          if (refresh == true) {
            _initialLoad(); // Ou o método que você usa para dar fetch nos posts
          }
        },
      ),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          ...posts.take(3).map((post) => _longCard(post.title, const Color.fromARGB(255, 85, 87, 102))).toList(),
  ...
  Widget _buildGastos(List<Post> posts) {
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return _longCard(post.title, const Color.fromARGB(255, 0, 200, 135));
      },
    );
  }
  ...
  Widget _longCard(String text, Color color) {
    return Container(
